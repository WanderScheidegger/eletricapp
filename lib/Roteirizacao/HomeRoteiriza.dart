...
class _HomeRoteirizaState extends State<HomeRoteiriza> with SingleTickerProviderStateMixin {
  ...
  //ALERT DIALOG
  _displayDialog(BuildContext context, String local, String setor) async {
    return showDialog(
        context: context,
        builder: (context) {
          return AlertDialog(
  ...
  _admLogin(String local, String setor) {
        ...
        child: ListView(
          ...
          children: <Widget>[
            ...
            ListTile(
              ...
              onTap: (){
                Navigator.pop(context);
                _displayDialog(context, "/admor", "pendencias");
              },
            ),
            ListTile(
              leading: CircleAvatar(
              ...
              onTap: (){
                Navigator.pop(context);
                _displayDialog(context, "/homesafework", "seguranca");
              },
            ),
            ListTile(
